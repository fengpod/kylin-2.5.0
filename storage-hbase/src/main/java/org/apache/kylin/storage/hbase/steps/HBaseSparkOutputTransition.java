...
public class HBaseSparkOutputTransition implements ISparkOutput {
    ...
    public ISparkBatchCubingOutputSide getBatchCubingOutputSide(final CubeSegment seg) {
        ...
        final HBaseJobSteps mrSteps = new HBaseMRSteps(seg);
        ...
        return new ISparkBatchCubingOutputSide() {
            ...
            @Override
            public void addStepPhase3_MRBuildCube(DefaultChainedExecutable jobFlow) {
                jobFlow.addTask(mrSteps.createConvertCuboidToHfileStep(jobFlow.getId()));
                jobFlow.addTask(mrSteps.createBulkLoadStep(jobFlow.getId()));
            }
